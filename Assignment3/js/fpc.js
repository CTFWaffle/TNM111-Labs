...
function focusPlusContext(data) {
    ...
    */
    ...
    small_points = dots.selectAll("dot")
      ...
      */
    var smallPointsObj = new Points();
    smallPointsObj.plot(small_points, 2, 2);
    ...
    */
    ...
    pointsObj.plot(selected_dots, 2, 2);
    ...
    //here..
    var brushContainer = context.append("g")
        .attr("class", "brush")
        .call(brush);
